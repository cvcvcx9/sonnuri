...
function Slider() {
  ...
  return (
    <div className="relative">
      ...
      {/* 사용자 정의 이전 버튼 */}
      <div
        className="absolute left-40 top-1/2 transform -translate-y-1/2 z-10 flex items-center justify-center w-10 h-10 bg-white rounded-full shadow cursor-pointer"
      ...
      {/* 사용자 정의 다음 버튼 */}
      <div
        className="absolute right-40 top-1/2 transform -translate-y-1/2 z-10 flex items-center justify-center w-10 h-10 bg-white rounded-full shadow cursor-pointer"
